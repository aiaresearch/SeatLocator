...
def update_data_1():
    ...
    if provided_password == password:
        ...
        return jsonify({'error': 'Password not provided, please set the password'}), 401
    else:
        return jsonify({'error': 'Incorrect password, connection refused'}), 401
...
def update_data_2():
    ...
    if provided_password == password:
        ...
        return jsonify({'error': 'Incorrect password, request denied'}), 401
